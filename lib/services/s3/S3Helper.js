...
class S3Helper {
     ...
     * @param acl
     */
    upload_s3_file(bucket_name_1, bucket_key_1, file_1) {
        return __awaiter(this, arguments, void 0, function* (bucket_name, bucket_key, file, content_type = 'text/plain', acl) {
            try {
     ...
     * @param content_type
     */
    upload_s3_file_path(bucket_name_1, bucket_key_1, file_path_1) {
        return __awaiter(this, arguments, void 0, function* (bucket_name, bucket_key, file_path, content_type = 'text/plain') {
            try {
    ...
    putObject(bucket_1, key_1, file_1) {
        return __awaiter(this, arguments, void 0, function* (bucket, key, file, content_type = 'application/json') {
            try {
                return yield this.s3Instance
                    .putObject({
                    Bucket: bucket,

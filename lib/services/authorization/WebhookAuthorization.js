...
class WebhookAuthorization {
    constructor() {
        this.API_WEBHOOKS_URL = process.env.API_WEBHOOKS_URL;
        this.API_WEBHOOKS_DEFAULT_URL = 'https://api.qa.digiventures.la';
    }
    /**
    ...
    login(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const url = `${this.API_WEBHOOKS_URL || this.API_WEBHOOKS_DEFAULT_URL}/authorization/${input.applicationId}/${input.secret}`;
            let response = null;
            try {
...
//# sourceMappingURL=WebhookAuthorization.js.map
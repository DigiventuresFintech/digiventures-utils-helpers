...
class ApiWebhooksService {
    ...
    exportDocumentToPdf(legajoId_1, fileId_1, mode_1) {
        return __awaiter(this, arguments, void 0, function* (legajoId, fileId, mode, options = {}) {
            if (!this.API_WEBHOOKS_BASE_URL) {
                throw `api webhooks url not defined`;
            }
            options = Object.assign(options, {
    ...
    getDocumentByMongoDBQuery(query_1) {
        return __awaiter(this, arguments, void 0, function* (query, options = {}) {
            if (!this.API_WEBHOOKS_BASE_URL) {
                throw `api webhooks url not defined`;
            }
    ...
    updateDocumentById(legajoId_1, data_1) {
        return __awaiter(this, arguments, void 0, function* (legajoId, data, options = {}) {
            if (!this.API_WEBHOOKS_BASE_URL) {
                throw `api webhooks url not defined`;
            }
            options = Object.assign(options, {

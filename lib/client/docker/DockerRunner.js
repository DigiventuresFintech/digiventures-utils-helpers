...
class DockerRunner {
    ...
    createContainer(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this.dockerode.createContainer(Object.assign(Object.assign({ name: params.name, Image: `${image}:${tag || 'latest'}`, Cmd: commands }, createOptions), { AttachStderr: true, AttachStdin: false, AttachStdout: true, OpenStdin: false, StdinOnce: false }));
            }
            catch (e) {

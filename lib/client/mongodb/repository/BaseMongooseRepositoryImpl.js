...
class BaseMongooseRepositoryImpl {
    ...
    getById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const entity = yield this.model
                .findOne({ _id: id }, (options === null || options === void 0 ? void 0 : options.projection) || {})
    ...
    findOne(condition, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const entity = yield this.model
                .findOne(condition, (options === null || options === void 0 ? void 0 : options.projection) || {})
                .populate(this.populate)
                .lean();
            if (!entity) {
                throw new Error('entity not found');
    ...
    getBy(condition, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const entity = yield this.model
                    .find(condition, (options === null || options === void 0 ? void 0 : options.projection) || {})
                    .lean({ getters: true });
                if (!entity) {
                    throw new Error('entity not found');
                }
    ...
    updateOne(condition, params, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const output = yield this.model
                .updateOne(condition, params, options || null)
                .lean();
            if (!output) {
                throw new Error('entities not found');
            }
    ...
    findOneAndUpdate(condition, params, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const output = yield this.model
                .findOneAndUpdate(condition, params, options || null)
                .lean();
            if (!output) {
                throw new Error('entities not found');
            }

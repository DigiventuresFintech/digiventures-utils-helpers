...
class DocumentManagerImpl extends BaseMongooseRepositoryImpl_1.BaseMongooseRepositoryImpl {
    constructor(connection) {
        super((0, common_1.createModel)('legajo', (encryption) => {
            return new mongoose_1.Schema({
                ...
                userId: String,
                userIp: String,
                tenantId: { type: mongoose_2.default.Types.ObjectId },
                email: String,
                idNumber: {
                    type: String,
                    get: (v) => (0, common_2.aesDecrypt)(encryption.key, encryption.iv, String(v)),
                    set: (v) => (0, common_2.aesEncrypt)(encryption.key, encryption.iv, String(v))
                },

...
exports.close = exports.connect = exports.instance = exports.MongodbMultiConn = void 0;
    ...
    connect(connections) {
        return __awaiter(this, void 0, void 0, function* () {
            const connectionPromises = Object.entries(connections).map(([key, config]) => __awaiter(this, void 0, void 0, function* () {
                const { string, options } = config.mongodb.connection;
                try {
                    this._connections[key] = yield mongoose_1.default.createConnection(string, options);
                }
                catch (err) {
...
function connect() {
    return __awaiter(this, void 0, void 0, function* () {
        return exports.instance.connect();
    });
}

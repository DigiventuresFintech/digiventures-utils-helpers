...
const createSchema = (encryption) => {
    const schema = new mongoose_1.Schema({
        ...
        idNumber: {
            type: String,
            get: (v) => (0, common_1.aesDecrypt)(encryption.key, encryption.iv, String(v)),
            set: (v) => (0, common_1.aesEncrypt)(encryption.key, encryption.iv, String(v))
        },
...
function createModel2(connection) {
    ...
    return connection
        ? connection.model('legajo', createSchema(encryption))
        : mongoose.model('legajo', createSchema(encryption));
}

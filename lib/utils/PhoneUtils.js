...
class PhoneUtils {
    ...
    parsePhoneNumber(phone, country = 'AR') {
        var _a, _b;
        const result = {};
        try {
            if (!phone)
                return {};
            const parsedPhoneNumber = (0, libphonenumber_js_1.default)(phone, country);
            if (parsedPhoneNumber) {
                ...
                if (arrLength === 2) {
                    ...
                    const areaCode = (_a = splitPhoneNumber
                        .slice(arrLength - 3, arrLength - 2)) === null || _a === void 0 ? void 0 : _a.join('');
                    const phoneNumber = (_b = splitPhoneNumber
                        .slice(arrLength - 2, arrLength)) === null || _b === void 0 ? void 0 : _b.join('');
                    if (areaCode)
                        result.areaCode = areaCode;
                    if (phoneNumber)
                        result.phoneNumber = phoneNumber;

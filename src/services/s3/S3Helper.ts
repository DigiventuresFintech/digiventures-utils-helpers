...
export class S3Helper {
     ...
     */
    public get_base64_mimetype = (base64: string): string => {
        const signatures = {
     ...
     */
    public mimetype_to_extension = (mimetype: string): string => {
        const extensions = {
            'application/pdf': 'pdf',
            'image/png': 'png',
            'image/jpg': 'jpg',
        ...
        return extensions[mimetype as keyof typeof extensions] ?? extensions.default;
    }
}

...
describe.skip(__filename, () => {
    ...
    describe('createBuyer', () => {
        test('should create a buyer successfully', async () => {
            ...
            const result = await apiBuyerService.createBuyer(buyerData, user, workspace);
        ...
        test('should throw error on createBuyer failure', async () => {
            ...
            const errorResponse = {
                response: {
                    data: { code: 'ERR_CREATE', message: 'Error in creation', reason: 'Validation failed' },
                },
            };

            mockedAxios.post.mockRejectedValueOnce(errorResponse);

            await expect(apiBuyerService.createBuyer(buyerData, user, workspace)).rejects.toEqual({
                code: 'ERR_CREATE',
    ...
    describe('getBuyers', () => {
        test('should get buyers successfully', async () => {
            ...
            const result = await apiBuyerService.getBuyers(workspace, user, queryParams);
        ...
        test('should throw error on getBuyers failure', async () => {
            ...
            await expect(apiBuyerService.getBuyers(workspace, user, queryParams)).rejects.toEqual({
    ...
    describe('updateBuyer', () => {
        test('should update a buyer successfully', async () => {
            ...
            const result = await apiBuyerService.updateBuyer(id, buyerData, workspace);
        ...
        test('should throw error on updateBuyer failure', async () => {
            ...
            const errorResponse = {
                response: {
                    data: { code: 'ERR_UPDATE', message: 'Update failed', reason: 'Not found' },
                },
            };

            mockedAxios.put.mockRejectedValueOnce(errorResponse);

            await expect(apiBuyerService.updateBuyer(id, buyerData, workspace)).rejects.toEqual({
                code: 'ERR_UPDATE',

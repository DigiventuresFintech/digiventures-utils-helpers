...
describe(__filename, () => {
    ...
    test('should generate csv from mongodb document successfully', () => {
        const legajo = {
            ...
            applicantParent: '',
            linkApplicant:
                'https://quieromimasteritau.tuonboarding.com?applicant=651c1da9e59bd5006d415d2e',
            linkRecover:
                'https://quieromimasteritau.tuonboarding.com?recover=651c1da9e59bd5006d415d2e&utm_recovery=true',
            ...
            products: {
                tarjeta_itau_mastercard_chat: {
                    dates: {
                        selected:
                            'Tue Oct 03 2023 13:57:13 GMT+0000 (Coordinated Universal Time)',
                        accepted:
                            'Tue Oct 03 2023 14:00:40 GMT+0000 (Coordinated Universal Time)',
                    },
                    status: 'accepted',
                    title: 'Mastercard Cuenta Chat',
                    documents: ['Formulario2067', 'Contrato'],
                    additional_products: {},
                },
            },
            information: {
                datosbasicos: {
                    ...
                    cuilCuit: {
                        ...
                        question:
                            'Compartinos tu nro. de identificación  fiscal',
                    },
                    paisNacimiento: {
                        answer: 'Argentina',
                    ...
                    residenciaJurisdiccion: {
                        answer: 'No',
                        question:
                            '¿Posee residencia a efectos fiscales en una o más jurisdicciones distintas de Argentina?',
                        value: 'No',
                    },
                },
                domicilio: {
                ...
                'domicilio-entrega': {
                    domIgual: {
                        answer: 'Si',
                        question:
                            'El domicilio de entrega es el mismo de antes?',
                    },
                },
                datosfamiliares: {
                    estadoCivil: {
                ...
                ingresosbrutos: {
                    condicionGanancias: {
                        answer: 'Monotributo',
                        question:
                            '¿Cual es tu condición frente al Impuesto a las Ganancias?',
                    },
                    condicionIva: {
                    ...
                    x0BHGWAVA: {
                        answer: 'Consumidor Final',
                        question:
                            '¿Cuál es tu condición frente a Ingresos Brutos?',
                    },
                },
                legales: {
                    actividadTitular: {
                        answer: 'No',
                        question:
                            '¿Algún titular de la cuenta realiza alguna de las actividades detalladas a continuación?',
                        value: 'No',
                    },
                    tipoActividad: {
                        answer: '',
